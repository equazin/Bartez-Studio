...
export const footer = {
  ...
  legalLine: "Bartez Tecnología · Responsable Inscripto · CUIT 20-21774424-6 · 9 de Julio 3418, Rosario, Santa Fe",
...
export const legalPages: LegalPage[] = [
  ...
  },
  {
    ...
    sections: [
      { h: "1. Objeto del sitio", p: "Este sitio es una vidriera comercial institucional de Bartez Tecnología, distribuidora mayorista de hardware IT y servicios. No es una tienda online: los productos y precios mostrados son de referencia y están sujetos a cotización y disponibilidad de stock." },
      { h: "2. Cotizaciones y precios", p: "Las cotizaciones se emiten a pedido y tienen una validez limitada que se indica en cada propuesta. Los precios pueden variar según disponibilidad, condiciones de pago y cotización de mercado. Ninguna información del sitio constituye una oferta vinculante." },
