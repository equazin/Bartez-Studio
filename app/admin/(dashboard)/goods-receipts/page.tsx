    ...
    <div className="mx-auto max-w-[1240px]">
      ...
      <AdminPanel className="mt-6 overflow-hidden">
        {loading ? (
          ...
          <div>
            <div className="hidden grid-cols-[.75fr_1fr_.75fr_.85fr_.45fr_.35fr] gap-3 border-b border-slate-300 bg-slate-100 px-6 py-3 text-[12px] font-semibold text-slate-700 lg:grid">
