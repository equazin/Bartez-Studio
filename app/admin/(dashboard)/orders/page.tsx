    ...
    <div className="mx-auto max-w-[1240px]">
      ...
      <AdminPanel className="mt-5 overflow-hidden">
        {loading ? (
          ...
          <div>
            <div className="hidden grid-cols-[.7fr_1.4fr_.7fr_.5fr_.5fr_.5fr_.4fr] gap-3 border-b border-slate-300 bg-slate-100 px-6 py-3 text-[11px] font-bold uppercase tracking-[0.08em] text-slate-700 lg:grid">
