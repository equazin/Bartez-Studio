...
export const metadata: Metadata = {
  ...
  description:
    "Conoce como acompaña Bartez las consultas de garantía y el proceso de RMA segun las condiciones aplicables a cada producto y fabricante.",
};

const steps = [
  { num: "01", icon: HelpCircle, title: "Detectas el problema", desc: "El equipo presenta una falla o defecto durante el periodo de garantía." },
  { num: "02", icon: AlertCircle, title: "Nos contactas", desc: "Escribinos con el problema, modelo, numero de serie y comprobante." },
  { num: "03", icon: FileCheck2, title: "Evaluamos el caso", desc: "Revisamos si corresponde garantía del fabricante o soporte técnico." },
  { num: "04", icon: RefreshCw, title: "Gestionamos la solución", desc: "Coordinamos retiro, reparacion o reemplazo segun corresponda." },
];

const covered = [
  "Defectos de fabricacion detectados durante el uso normal.",
  "Fallas de hardware bajo condiciones normales de operación.",
  "Componentes defectuosos dentro del periodo de garantía.",
  "Problemas asociados al equipo segun condiciones del fabricante.",
];

const notCovered = [
  "Daños por golpes, liquidos o mal uso del equipo.",
  "Modificaciones o reparaciones realizadas por terceros.",
  "Desgaste normal por uso y consumibles fuera de cobertura.",
  "Perdida de datos: recomendamos backup previo a cualquier gestion.",
];

const brands = [
  { name: "Dell", warranty: "1 a 3 años segun línea; ProSupport disponible." },
  { name: "Lenovo", warranty: "1 a 3 años segun línea y cobertura contratada." },
  { name: "HP", warranty: "1 año base con extensiones disponibles." },
  { name: "Cisco", warranty: "Varia por modelo y contrato; consultar." },
  { name: "Kingston", warranty: "Segun línea de memoria, SSD o accesorio." },
  { name: "Intel / AMD", warranty: "Segun producto, version boxed y condiciones del fabricante." },
];
    ...
    <InternalPageShell>
      <InternalHero
        ...
        mediaItems={[
          ...
          { icon: Truck, title: "Logistica", description: "Coordinacion segun caso y ubicacion." },
        ...
        metrics={[
          ...
          { value: "ARG", label: "gestion nacional" },
        ]}
        actions={[
