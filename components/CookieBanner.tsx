...
export function CookieBanner() {
  ...
  return (
    <div className="fixed inset-x-3 bottom-3 z-[45] mx-auto max-w-[560px] rounded-2xl border border-white/10 bg-[#070a16] p-4 text-white shadow-2xl md:left-6 md:right-auto">
