...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-[60] grid h-14 w-14 place-items-center rounded-full bg-verde text-white shadow-[0_14px_30px_-8px_rgba(20,83,45,.6)] transition-all hover:scale-110 hover:bg-verde-acento"
    >
