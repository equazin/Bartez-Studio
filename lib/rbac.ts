...
const ROLE_PERMISSIONS: Record<Role, readonly string[]> = {
  ...
  member: [
    ...
    "ventas:order:create",
    "ventas:order:update",
    "ventas:delivery-note:read",
    "ventas:delivery-note:create",
    "compras:po:read",
    "compras:po:create",
    "compras:receipt:read",
    "compras:receipt:create",
    "compras:supplier:read",
    "compras:supplier:create",
    "compras:supplier:update",
    "finanzas:payable:read",
    "finanzas:supplier-payment:read",
    "finanzas:supplier-payment:create",
    "finanzas:cash:read",
    "finanzas:cash:create",
    "finanzas:export:read",
    "inventario:stock:read",
    "postventa:ticket:read",
    "postventa:ticket:create",
    "postventa:ticket:update",
    "postventa:warranty:read",
    "postventa:warranty:create",
    "postventa:warranty:update",
    "postventa:work-order:read",
    "postventa:work-order:create",
    "postventa:work-order:update",
    "postventa:knowledge:read",
    "postventa:knowledge:create",
    "postventa:knowledge:update",
    "reportes:read",
    "contenido:*",
    "analytics:read",
  ],
  viewer: [
    ...
    "compras:supplier:read",
    "inventario:stock:read",
    "finanzas:account:read",
    "finanzas:receipt:read",
    "finanzas:payable:read",
    "finanzas:supplier-payment:read",
    "finanzas:cash:read",
    "finanzas:export:read",
